 ...
 *
 */
public class EventGallery implements Parcelable {
    ...
    public EventGallery(SparseArray<Object> values) {
        this.values = values;
    }
    ...
    public static Creator CREATOR = new Creator<EventGallery>() {
        @Override
        public EventGallery createFromParcel(Parcel source) {
            return new EventGallery(source.readSparseArray(EventGallery.class.getClassLoader()));
        }

        @Override
        public EventGallery[] newArray(int size) {
            return new EventGallery[size];
        }
    };
}
